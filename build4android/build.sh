...
#
# Build:
#   - git clone -b dev https://github.com/LeeReindeer/clashr
#   - cd clashr
...
go build -ldflags "-X \"github.com/LeeReindeer/clashr/constant.Version=$VERSION\" -X \"github.com/LeeReindeer/clashr/constant.BuildTime=$BUILDTIME\" -w -s" \
